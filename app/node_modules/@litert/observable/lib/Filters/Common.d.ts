 ...
 */
export declare type PromiseType<T> = T extends Promise<infer P> ? P : T;
...
export interface IFilterManager {
     ...
     */
    register<T extends IFilterTemplate = IFilterTemplate>(name: T['name'] | Array<T['name']>, key: string | symbol, callback: T['callback'], priority?: number): this;
    /**
     ...
     */
    filter<T extends IFilterTemplate = IFilterTemplate>(name: T['name'], ...args: Parameters<T['callback']>): Promise<PromiseType<ReturnType<T['callback']>>>;
    /**
