 ...
 */
export declare type ICallback = (...args: any[]) => void | false;
...
export interface IEmitter<T extends ICallbackDefinitions> extends IObservable<T> {
    /**
     ...
     */
    configEvent<TEvent extends keyof T>(event: TEvent, config: Partial<IConfiguration>): this;
    /**
