 ...
 */
export declare type TPromiseIdentity = string | symbol;
export declare const ANONYMOUS_PROMISE: unique symbol;
export interface ISubjectTimeoutResult {
    subject: 'promise:timeout_result';
    callback(success: boolean, result: any, target?: string, issuer?: string): Promise<void>;
}
