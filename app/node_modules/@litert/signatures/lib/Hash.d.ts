...
export declare function hash(algo: IAlgorithms, message: Buffer | string): Buffer;
export declare function hashStream(algo: IAlgorithms, message: Readable): Promise<Buffer>;
export declare function createHasher(algo: IAlgorithms): C.IHasher;
