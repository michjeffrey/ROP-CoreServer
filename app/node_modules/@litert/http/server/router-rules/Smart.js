...
(function (VarType) {
    ...
    VarType[VarType["SKIPPED"] = 4] = "SKIPPED";
})(VarType || (VarType = {}));
        ...
        path = path.replace(/\{.+?:.+?\}|[\*\?]/g, function (el) {
            ...
            switch (matchResult[2]) {
                ...
                default:
                    ...
                    throw new Exception_1.default(Errors_1.default.INVALID_VARIABLE_TYPE, `Invalid expression ${el} of variable.`);
            }
...
exports.default = SmartRouteRule;
