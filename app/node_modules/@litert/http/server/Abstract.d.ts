...
export interface ServerResponse extends http.ServerResponse {
     ...
     * > NOTES: This must be called with setting up cookies for server.
     */
    setCookie(name: string, value: string, ttl?: number, httpOnly?: boolean, secureOnly?: boolean, path?: string, domain?: string): this;
    /**
     * Set the cookies of response.
     *
     * > NOTES: This must be called with setting up cookies for server.
     */
    setCookie(cookie: SetCookieConfiguration): this;
}
export declare type RequestHandler<CT extends RequestContext = RequestContext> = (context: CT) => Promise<void>;
export declare type MiddlewareNextCallback = (end?: boolean) => Promise<void>;
export declare type RequestMiddleware<CT extends RequestContext = RequestContext> = (context: CT, next: MiddlewareNextCallback) => Promise<void>;
...
export interface SSLConfig {
     ...
     */
    "minProtocolVersion"?: "SSLv2" | "SSLv3" | "TLSv1.0" | "TLSv1.1" | "TLSv1.2";
}
/**
 * The factory function for context object.
 */
export declare type ContextCreator<T extends RequestContext> = (request: ServerRequest, response: ServerResponse) => T;
export declare type HTTPVersion = 1.1 | 2;
/**
...
export declare enum CookiesEncoding {
    PLAIN = 0,
    BASE64 = 1,
    HEX = 2,
    URLENCODE = 3,
...
export interface ContentParser {
    parse(request: ServerRequest, opts: GetContentOptions<string>): Promise<any>;
}
...
export interface StandardRouter<CT extends RequestContext = RequestContext> extends Router {
    /**
     ...
     */
    use(method: HTTPMethod | HTTPMethod[], path: string | RegExp | Array<string | RegExp>, middleware: RequestMiddleware<CT>): this;
    /**
     ...
     * @param middleware The middleware handler.
     */
    use(method: HTTPMethod | HTTPMethod[], middleware: RequestMiddleware<CT>): this;
    /**
     ...
     * @param middleware The middleware handler.
     */
    use(path: string | RegExp | Array<string | RegExp>, middleware: RequestMiddleware<CT>): this;
    /**
     * Use a middleware, without any filter.
     *
     * @param middleware the middleware handler.
     */
    use(middleware: RequestMiddleware<CT>): this;
    /**
...
export interface ControllerRouter<CT extends RequestContext = RequestContext> extends StandardRouter<CT> {
    /**
...
export declare const DEFAULT_VERSION: HTTPVersion;
export declare const EXCEPTION_TYPE: string;
export declare const DEFAULT_MIN_SSL_VERSION = "TLSv1.0";
