...
export declare type IRIDGenerator = () => string | number;
...
export interface IClient<TAPIs extends G.IServiceAPIs = G.IServiceAPIs> extends Events.IObservable<Events.ICallbackDefinitions> {
     ...
     */
    invoke<TKey extends keyof TAPIs>(api: TKey, ...args: TAPIs[TKey] extends G.IFunction ? Parameters<TAPIs[TKey]> : never): Promise<TAPIs[TKey] extends G.IFunction ? ReturnType<TAPIs[TKey]> : never>;
    /**
     ...
     * @param args  The arguments of API.
     */
    call<TKey extends keyof TAPIs>(api: TKey, ...args: TAPIs[TKey] extends G.IFunction ? Parameters<TAPIs[TKey]> : never): Promise<IResponse<TAPIs[TKey]>>;
    close(): Promise<void>;
}
