...
export declare enum ETLSVersion {
    TLS_V1 = 1,
    TLS_V1_1 = 1.1,
    TLS_V1_2 = 1.2,
    TLS_V1_3 = 1.3
...
export interface IRequestOptionsInput extends B.CreateInputOptions<IRequestOptions, 'method', Exclude<keyof IRequestOptions, 'method' | 'url'>> {
    url: string | IUrl;
}
export declare const DEFAULT_PROTOCOL_DETECTION_CACHE_TTL = 60000;
export declare const DEFAULT_KEEP_ALIVE_TTL = 60000;
