...
exports.AbstractHttp2Client = void 0;
const C = require("../Common");
const AbstractProtocolClient_1 = require("./AbstractProtocolClient");
const $H2 = require("http2");
const stream_1 = require("stream");
const INITIAL_CONN_ID_COUNTER = 0;
class AbstractHttp2Client extends AbstractProtocolClient_1.AbstractProtocolClient {
    constructor(_) {
        super();
        this._ = _;
        this._connIndex = INITIAL_CONN_ID_COUNTER;
        this._connections = {};
    }
    close() {
    ...
    async _getConnection(opts, h2Opts, key) {
        ...
        return new Promise((resolve, reject) => {
            ...
            session.once('connect', () => {
                ...
                resolve([connId, pool.connections[connId]]);
            }).once('error', reject);
        });
    }
    _releaseConnection(key, connId, conn) {
        conn.concurrency--;
    ...
    async _processRequest(opts, key = this.getAuthorityKey(opts)) {
        const headers = {
        ...
        const [connId, conn] = await this._getConnection(opts, this._prepareOptions(opts), key);
        try {
            ...
            return await new Promise((resolve, reject) => {
                req.on('response', (respHeaders) => {
                    resolve({
                        ...
                        'stream': req,
                        'headers': respHeaders,
                        'statusCode': parseInt(respHeaders[$H2.constants.HTTP2_HEADER_STATUS]),
                        'contentLength': respHeaders[$H2.constants.HTTP2_HEADER_CONTENT_LENGTH] === undefined ?
                            Infinity : parseInt(respHeaders[$H2.constants.HTTP2_HEADER_CONTENT_LENGTH]),
...
exports.AbstractHttp2Client = AbstractHttp2Client;
//# sourceMappingURL=AbstractHttp2Client.js.map