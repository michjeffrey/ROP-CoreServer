...
export declare class H2Client extends AbstractHttp2Client implements A.IProtocolClient {
    constructor(helper: A.IHelper);
    request(opts: C.IRequestOptions): Promise<A.IRequestResult>;
    protected _prepareOptions(opts: C.IRequestOptions): $H2.ClientSessionOptions;
    getAuthorityKey(opts: C.IRequestOptions): string;
}
//# sourceMappingURL=H2Client.d.ts.map